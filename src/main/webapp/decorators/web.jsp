...
<link href="<c:url value='/template/comment/jquery-comments.css'/>" rel="stylesheet" type="text/css">
...
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/jquery/1.9.0/jquery.min.js"></script>
		<script src="<c:url value='/template/comment/jquery-comments.js'/>"></script>
</head>
<body>
