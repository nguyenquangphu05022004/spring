        ...
        <script>
            ...
            function addNew(data) {
                $.ajax({
                    ...
                    success: function (result) {
                        window.location.href = "${editNewURL}?" +result.id+"&message=insert_success";
                    },
            ...
            function updateNew(data) {
                $.ajax({
                    ...
                    contentType: "application/json",
                    success: function (result) {
                        window.location.href = "${editNewURL}?"+result.id+"&message=update_success";

                    },
                    error: function(response) {
                        window.location.href = "${editNewURL}?"+result.id+"&message=error_system";
                    }
                });
            }
