    ...
    <body>
        ...
        <script>
            ...
            function warningBeforeDelete() {
                ...
                swal({
                title: "Bạn có chắc rằng muốn xóa?",
                icon: "warning",
                buttons: true,
                dangerMode: true,
                })
                ...
                if (willDelete) {
                    ...
                    // icon: "success",
                    // });
                    var checkboxElement = $("input:checked");
                    var ids = [];
                    $.each(checkboxElement, function (indexInArray, valueOfElement) { 
                         ids.push(valueOfElement.value);
                    });
